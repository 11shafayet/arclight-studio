    ...
    <Link to={`/projects/${project.slug}`} className={`group block ${offset ? "lg:mt-[64px]" : ""}`}>
      <div className="relative aspect-[1.31] overflow-hidden rounded-[8px] bg-ink">
        <img
          src={project.image}
          alt={project.alt}
          className="absolute left-0 right-0 top-[-118px] h-[calc(100%+140px)] w-full object-cover object-center transition-transform duration-500 ease-out group-hover:scale-[1.045]"
        />
      </div>
...
export default function ProjectsSection() {
  return (
    <section id="projects" className="relative overflow-hidden py-[92px] text-ink max-[900px]:py-16">
      <div className="mx-auto w-[calc(100%-120px)] max-w-[1440px] max-[900px]:w-[calc(100%-48px)]">
        ...
        <div className="mt-[54px] grid grid-cols-[minmax(0,0.62fr)_minmax(280px,0.38fr)] gap-10 max-[900px]:grid-cols-1">
          <h2 className="text-[clamp(48px,6.53vw,94px)] font-bold uppercase leading-[1] tracking-[-0.045em] text-[rgb(23,23,23)]">
            Projects
            <br />
            (27)
          </h2>
          <p className="max-w-[390px] justify-self-end pt-[50px] text-left text-[clamp(18px,1.53vw,22px)] font-medium leading-[1.2] tracking-[-0.9px] text-[rgb(23,23,23)] max-[900px]:justify-self-start max-[900px]:pt-0">
        ...
        <div className="mt-[70px] grid grid-cols-2 gap-x-[16px] gap-y-[60px] max-[760px]:grid-cols-1">
