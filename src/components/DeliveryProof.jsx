...
export default function DeliveryProof() {
  return (
    <section className="relative overflow-hidden py-[72px] text-ink max-[900px]:py-16">
      <div className="mx-auto w-[calc(100%-120px)] max-w-[1440px] max-[900px]:w-[calc(100%-48px)]">
        ...
        <div className="delivery-layout relative pt-[64px] max-[900px]:grid max-[900px]:gap-12 max-[900px]:pt-12">
          <div className={proofStats[0].className}>
            <p className="text-[50px] font-semibold leading-none tracking-[-2.2px] text-ink max-[900px]:text-[44px]">
              {proofStats[0].value}
            </p>
          ...
          <h2 className="delivery-heading max-w-[760px] text-[64px] font-bold uppercase leading-[0.98] tracking-[-2.9px] text-ink max-[1100px]:text-[56px] max-[900px]:text-[44px]">
            APPROVED DESIGNS
            <br />
            SHIPPED WITHOUT
            <br />
          ...
          <div className={proofStats[2].className}>
            <p className="text-[38px] font-semibold uppercase leading-none tracking-[-1.75px] text-ink max-[900px]:text-[34px]">
              {proofStats[2].value}
            </p>
