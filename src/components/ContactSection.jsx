...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-[#f7f7f7] py-[42px] pb-[116px] text-ink max-[900px]:py-16">
      <div className="mx-auto w-[calc(100%-120px)] max-w-[1440px] max-[900px]:w-[calc(100%-48px)]">
        <SectionHeader />

        <div className="mt-[106px] grid grid-cols-[minmax(0,0.47fr)_minmax(420px,0.53fr)] gap-[96px] max-[1100px]:grid-cols-1 max-[1100px]:gap-12 max-[900px]:mt-16">
          <div className="flex min-h-[520px] flex-col justify-between max-[1100px]:min-h-0 max-[1100px]:gap-16">
            <div>
              ...
              <h2 className="mt-[28px] max-w-[560px] text-[clamp(40px,3.34vw,48px)] font-bold uppercase leading-[56px] tracking-[-2px] text-ink max-[720px]:text-[40px] max-[720px]:leading-[46px]">
                Have an approved
                <br />
                design ready for
                <br />
            ...
            <div>
              ...
              <a
                ...
                className="mt-[14px] inline-block text-[18px] font-medium leading-[24px] tracking-[-0.1px] text-[rgb(248,40,40)] underline underline-offset-2"
              >
          ...
          <form className="bg-[#f2f2f2] px-[28px] pb-[28px] pt-[30px] max-[720px]:px-[20px]" onSubmit={handleSubmit}>
