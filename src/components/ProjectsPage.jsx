...
function CaseProjectCard({ project }) {
  return (
    <Link to={`/projects/${project.slug}`} className="group block w-full cursor-pointer no-underline">
      <div className="relative h-[560px] w-full overflow-hidden rounded-[10px] bg-ink max-[809px]:h-[390px]">
        <img
          src={project.image}
          alt={project.alt}
          className="absolute inset-x-0 top-[-60px] h-[calc(100%+120px)] w-full object-cover object-center transition-transform duration-500 ease-out group-hover:scale-[1.05]"
        />
      ...
      <div className="mt-[14px] flex h-[25px] items-start justify-between gap-5 overflow-hidden text-[22px] font-medium leading-[1.2] tracking-[-1.3px] text-ink">
        <span className="relative grid h-[25px] overflow-hidden whitespace-nowrap">
  ...
  return (
    <>
      <main className="relative overflow-hidden bg-[#ededed] px-5 py-[160px] text-ink max-[809px]:px-0 max-[809px]:py-0">
        <section id="projects" className="relative z-10 px-8 pb-[120px] pt-[200px] max-[1199px]:pt-[180px] max-[809px]:px-6 max-[809px]:pb-20 max-[809px]:pt-[160px]">
          <motion.div
          ...
          <div className="mx-auto grid w-full max-w-[1380px] gap-10">
            <motion.div {...reveal} className="grid grid-cols-7 gap-6 overflow-hidden mix-blend-difference max-[809px]:flex max-[809px]:flex-col max-[809px]:items-start">
              ...
              <div className="col-span-5 grid gap-[15px] overflow-hidden">
                <h1 className="text-[84px] font-bold uppercase leading-[86px] tracking-[-2.1px] text-ink max-[1199px]:text-[78px] max-[1199px]:leading-[80px] max-[809px]:text-[56px] max-[809px]:leading-[64px] max-[809px]:tracking-[-2.6px]">
                  Selected
                  <br />
                  projects
                </h1>
                <div className="max-w-[720px] text-[18px] font-medium leading-[1.2] tracking-[-1px] text-ink">
