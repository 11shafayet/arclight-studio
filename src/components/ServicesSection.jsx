...
export default function ServicesSection() {
  return (
    <section id="services" className="relative overflow-visible py-[92px] text-ink max-[900px]:py-16">
      <div className="mx-auto w-[calc(100%-120px)] max-w-[1440px] max-[900px]:w-[calc(100%-48px)]">
        ...
        <h2 className="mt-[58px] max-w-[940px] text-[clamp(48px,5.55vw,80px)] font-bold uppercase leading-[0.96] tracking-[-0.055em] text-[rgb(23,23,23)] max-[720px]:mt-10">
          Development Support
          <br />
          Where Agencies
          <br />
