...
export default function PricingSection() {
  return (
    <section
      id="pricing"
      className="relative overflow-hidden py-[100px] text-ink max-[900px]:py-16"
      style={{
        background:
    ...
    >
      <div className="mx-auto w-[calc(100%-120px)] max-w-[1440px] max-[900px]:w-[calc(100%-48px)]">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="mt-[20px] text-[clamp(40px,4.75vw,72px)] font-bold uppercase leading-[0.98] tracking-[-0.05em] text-ink">
            Start with One Page.
          </h2>
        </div>

        <div className="mt-[52px] w-full rounded-[18px] border border-white/35 bg-white/15 p-[20px] shadow-[0_1px_0_rgba(23,23,23,0.03)] backdrop-blur-[1px] max-[900px]:mt-10 max-[900px]:p-4">
          <div className="rounded-[14px] border border-white/60 bg-white/72 px-[28px] py-[48px] text-center shadow-[0_0_0_1px_rgba(255,255,255,0.18)_inset] max-[900px]:px-5 max-[900px]:py-10">
            ...
            <p className="mt-[16px] text-[clamp(40px,4.5vw,48px)] font-bold leading-[56px] tracking-[-0.08em] text-ink">
              $300
            </p>
